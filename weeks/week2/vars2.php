...
echo "<br>";
echo 'Alex\'s favorite color is '.$color.'';
...
$total *= 1.097;
echo $total;
echo '<h3>We would like our amount to refelct 2 decimal places -- we are thinking about floats and a new function -- number_format()</h3>';
