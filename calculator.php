...
<html>
    <head>
        <meta charset="UTF-8">
        <link rel="stylesheet" href="css/stylesCalc.css">
    </head>
    <body>
        ...
        <fieldset>
                ...
                <select name="mpg">
                    ...
                    <option value="10" <?php if(isset($_POST['mpg']) && $_POST['mpg'] == '10') echo 'selected="selected"';?> >Horrible @ 10 mpg</option>
                    <option value="15" <?php if(isset($_POST['mpg']) && $_POST['mpg'] == '15') echo 'selected="selected"';?>>OK @ 15 mpg</option>
        ...
        <footer>
        <li><a href="https://github.com/AlexBuck1/IT261">Github</a></li>
        </footer>
